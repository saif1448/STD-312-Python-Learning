...
def get_student_statics(student_data):
    ...
    for student in student_data:
        if student['UnitMark'] == highest_mark:
            highest_mark_list.append((student['Name'], student['ID']))

    for student in student_data:
        if student['UnitMark'] == lowest_mark:
            lowest_mark_list.append((student['Name'], student['ID']))

    avg_mark = sum_mark / student_count
    return (avg_mark, highest_mark, lowest_mark, failed_std_count, highest_mark_list, lowest_mark_list)

student_data = take_student_input_data()

avg_mark, highest_mark, lowest_mark, failed_std_count, highest_mark_list,lowest_mark_list = get_student_statics(student_data)
...
print(f"Highest Grade List: {highest_mark_list}")
print(f"Lowest Grade List: {lowest_mark_list}")
